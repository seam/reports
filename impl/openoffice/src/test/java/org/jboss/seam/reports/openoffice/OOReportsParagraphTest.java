...
import org.jboss.seam.reports.openoffice.lib.contenthandler.OODefaultParagraphIterator;
...
public class OOReportsParagraphTest {
	...
	@Inject @Resource("paragraphIteratorTemplate.odf") InputStream input;
	...
	public void hide() throws Exception {
		...
		FileOutputStream fos = new FileOutputStream("target/hidden-paragraph-output.odf");
		renderer.render(report, fos);
		fos.close();
		
		TextDocument tester = TextDocument.loadDocument("target/hidden-paragraph-output.odf");
		assertTrue(tester.getContentRoot().toString().contains("Alberto Gori"));
	}
