...
public class OOSeamReportDataSource implements ReportDataSource {
    ...
    private List<OOContentHandler> components = new ArrayList<OOContentHandler>();

    @Override
    public List<OOContentHandler> getDelegate() {
        return components;
    }

    public void add(OOContentHandler component) {
